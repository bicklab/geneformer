# GeneFormer Convert Loompy to Tokenized Dataset (Not diseased)
# Author: Yash Pershad
# Date: 03/11/2024
#
...
def reformat_loom(ds, filename):
    ...
    col_attrs['organ_major'] = len(col_attrs['nCount_RNA'])*['bone_marrow']
...
def main():
    ...
    tk = TranscriptomeTokenizer({"cell_type": "cell_type", "organ_major": "organ", "n_counts": "n_counts"}, nproc=16)
