...
def reformat_loom(ds, filename):
    ...
    col_attrs = {
            ...
            "IntegratedStim": ds.ca['IntegratedStim'],
            "IntegratedCellType": ds.ca['IntegratedCellType'],
            "study": ds.ca['study']
    }
...
def main():
    ...
    tk = TranscriptomeTokenizer({"n_counts": "nCount_RNA",
                                 "study": "study",
                                 "IntegratedStim": "IntegratedStim",
                                 "IntegratedCellType": "IntegratedCellType"}, nproc=16)
