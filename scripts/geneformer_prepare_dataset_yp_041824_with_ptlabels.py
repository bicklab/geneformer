...
def reformat_loom(ds, filename):
    ...
    col_attrs['chive_id'] = col_attrs['CHIVEID']
...
def main():
    ...
    tk = TranscriptomeTokenizer({"cell_type": "cell_type", "organ_major": "organ", "n_counts": "n_counts", "group": "group", "chive_id": "chive_id"}, nproc=16)
