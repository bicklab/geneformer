# GeneFormer Convert Reformatted Loompy to Tokenized Dataset
# Author: Yash Pershad
# Date: 01/27/2024
#
...
def main():
    ...
    tk = TranscriptomeTokenizer({"cell_type": "cell_type", "organ_major": "organ", "n_counts": "n_counts", "group": "group"}, nproc=16)
