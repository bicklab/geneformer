...
python geneformer_prepare_dataset_yp_09292024_lippmann.py --path_to_loom /grand/GeomicVar/pershy1/data/looms/enl4it_ensembl.loom --path_to_reformatted_loom /grand/GeomicVar/pershy1/data/reformatted_looms/lippmann_enl4it/enl4it_ensembl.loom --path_to_loom_directory /grand/GeomicVar/pershy1/data/reformatted_looms/lippmann_enl4it/ --output_dir /grand/GeomicVar/pershy1/data/datasets/lippmann_enl4it --output_prefix lippmann_enl4it

python geneformer_build_classifier_yp_012724.py --path_to_train_dataset /grand/GeomicVar/pershy1/data/datasets/lippmann_enl4it/lippmann_enl4it.dataset --classification enl4it --pretrained_model /grand/GeomicVar/pershy1/Geneformer/geneformer-12L-30M --finetuned_model_output_path /grand/GeomicVar/pershy1/classifiers --label_name type