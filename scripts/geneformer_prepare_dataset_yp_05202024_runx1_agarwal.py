...
def reformat_loom(ds, filename):
    ...
    col_attrs['cell_type'] = col_attrs['new_cell_type']
    col_attrs['label'] = col_attrs['orig.ident']
...
def main():
    ...
    tk = TranscriptomeTokenizer({"cell_type": "cell_type", "organ_major": "organ", "n_counts": "n_counts", "label": "label"}, nproc=16)
